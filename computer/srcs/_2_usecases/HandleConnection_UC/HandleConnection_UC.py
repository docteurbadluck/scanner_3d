...
async def handle_connection(
    ...
    await _send_initial_status(
        connection, pi_provider, state_provider, pico_state_provider, scan_list_provider,
    )
    async for message in connection:
        await handle_incoming(connection, str(message), pi, pi_provider, run_scan)
